...
namespace MonsterHunter_Database
{
    ...
    public class MonsterHunterWeapon
    {
        ...
        public MonsterHunterWeapon(int id, string name, string weaponClass, int damageValue, double motionValue, string sharpnessColor, string rank)
        {
            Id = id;
            Name = name;
            WeaponClass = weaponClass;
